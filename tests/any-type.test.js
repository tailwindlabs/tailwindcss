    ...
    content: [
      {
        raw: html`
          ...
          <div class="border-x-[var(--any-value)] border-y-[var(--any-value)]"></div>
          <div class="border-t-[var(--any-value)] border-r-[var(--any-value)]"></div>
          <div class="border-b-[var(--any-value)] border-l-[var(--any-value)]"></div>
          <div class="bg-[var(--any-value)]"></div>
          <div class="from-[var(--any-value)] via-[var(--any-value)] to-[var(--any-value)]"></div>
          <div class="stroke-[var(--any-value)] fill-[var(--any-value)]"></div>
