...
<div class="w-full max-w-screen-xl mx-auto px-6">
  <div class="lg:flex -mx-6">
    ...
    {{-- Side nav --}}
    <div id="sidebar" class="hidden fixed inset-0 overflow-y-auto scrolling-touch bg-white z-90 top-16 w-full border-b -mb-16 lg:-mb-0 lg:static lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5">
      ...
      <div id="navWrapper" class="lg:block lg:relative lg:sticky lg:top-16 bg-white lg:bg-transparent overflow-hidden">
        ...
        <nav id="nav" class="px-6 pt-6 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-(screen-16)">
          <div class="mb-10">
            <a href="/docs/installation" class="flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->active('/docs') ? 'text-gray-900' : 'text-gray-600' }}">
            ...
            <a href="/components/alerts" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->active('/components') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="/community" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->active('/community') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
