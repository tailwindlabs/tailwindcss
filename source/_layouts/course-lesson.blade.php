        ...
        <div class="flex items-center -mx-6">
          ...
          <div class="flex flex-grow lg:w-3/4 xl:w-4/5">
            ...
            <div class="w-full lg:px-6 xl:w-3/4 xl:px-12">
              <div class="relative">
                <input id="docsearch" class="transition focus:outline-0 border border-transparent focus:bg-white focus:border-gray-300 placeholder-gray-600 rounded-lg bg-gray-200 py-2 pr-4 pl-10 block w-full appearance-none leading-normal" type="text" placeholder="Search the docs (Press &quot;/&quot; to focus)">
    ...
    <div id="sidebar" class="hidden fixed inset-0 pt-16 h-full bg-white z-90 w-full border-b -mb-16 lg:-mb-0 lg:static lg:h-auto lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5">
      ...
      <div id="navWrapper" class="h-full overflow-y-auto scrolling-touch lg:h-auto lg:block lg:relative lg:sticky lg:top-16 bg-white lg:bg-transparent">
        ...
        <nav id="nav" class="px-6 pt-6 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-(screen-16)">
          ...
          <div class="mb-10">
            <a href="/docs/installation" class="flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/docs') ? 'text-gray-900' : 'text-gray-600' }}">
            ...
            <a href="/components" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/components') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="/screencasts" data-external class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ ($page->categoryActive('/course') || $page->categoryActive('/screencasts')) ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="/resources" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/resources') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a href="/community" class="mt-3 lg:mt-1 flex items-center px-2 -mx-2 py-1 hover:text-gray-900 font-medium {{ $page->categoryActive('/community') ? 'text-gray-900' : 'text-gray-600' }}">
              <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <div class="mb-8">
            @if ($sectionItems->first() === '/course/coming-soon')
            <h5 class="mb-3 lg:mb-2 text-gray-400 uppercase tracking-wide font-bold text-sm lg:text-xs">{{ $sectionName }}</h5>
            @else
            ...
            <ul>
              @foreach ($sectionItems as $name => $link)
                <li class="mb-3 lg:mb-1">
                  @if ($link === '/course/coming-soon')
                  <a class="px-2 -mx-2 py-1 relative block text-gray-400 font-medium" href="{{ $page->getLink($link) }}" {{ $page->isExternal($link) ? 'data-external' : '' }}>
                  @else
