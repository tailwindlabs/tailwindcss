<template>
  <div>
    <div class="flex items-end justify-center mb-2 bg-white">
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'none' ? 'text-gray-800' : 'text-grey-dark'" @click="activeScreen = 'none'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'sm' ? 'text-gray-800' : 'text-grey-dark'" @click="activeScreen = 'sm'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'md' ? 'text-gray-800' : 'text-grey-dark'" @click="activeScreen = 'md'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none mr-8" :class="activeScreen === 'lg' ? 'text-gray-800' : 'text-grey-dark'" @click="activeScreen = 'lg'" >
      ...
      <span class="inline-block text-center cursor-pointer select-none" :class="activeScreen === 'xl' ? 'text-gray-800' : 'text-grey-dark'" @click="activeScreen = 'xl'" >
