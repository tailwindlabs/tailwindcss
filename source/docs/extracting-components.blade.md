...
<button class="bg-gray-400 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded">
  Button
</button>
...
.btn-grey {
  @@apply bg-gray-400 text-grey-darkest font-bold py-2 px-4 rounded;
}
.btn-grey:hover {
  @@apply bg-grey;
}
...
.btn-grey {
  @@apply bg-gray-400 text-grey-darkest;
}
.btn-grey:hover {
  @@apply bg-grey;
}
