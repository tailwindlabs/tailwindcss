...
<pre class="h-128 overflow-y-scroll language-javascript"><code>{!! str_replace('// var defaultConfig', 'var defaultConfig', file_get_contents(dirname(__DIR__).'/node_modules/tailwindcss/defaultConfig.stub.js')) !!}</code></pre>
