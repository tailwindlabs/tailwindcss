...
<div class="inline-flex">
  <button class="bg-gray-400 hover:bg-grey text-gray-800 font-bold py-2 px-4 rounded-l">
    Prev
  </button>
  <button class="bg-gray-400 hover:bg-grey text-gray-800 font-bold py-2 px-4 rounded-r">
    Next
  </button>
</div>
@endcomponent
...
@component('_partials.code-sample', ['lang' => 'html', 'class' => 'text-center'])
<button class="bg-gray-400 hover:bg-grey text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
