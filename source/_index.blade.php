  ...
  <div class="min-h-screen bg-pattern bg-center bg-gray-200 border-t-6 border-tailwind-teal flex items-center justify-center leading-tight p-6 pb-16">
    <div>
      <div>
        ...
        <p class="text-center">
          <a href="https://github.com/tailwindcss/tailwindcss/releases" class="text-lg text-gray-500 hover:text-gray-600 font-semibold tracking-tight">v{{ $page->version }}</a>
        </p>
      </div>
