...
<div class="flex flex-col">
  <div class="min-h-screen bg-pattern bg-center bg-gray-200 border-t-6 border-tailwind-teal flex items-center justify-center leading-tight p-6 pb-16">
    <div>
      <div>
        ...
        <p class="text-center">
          <a href="https://github.com/tailwindlabs/tailwindcss/releases" class="text-lg text-gray-500 hover:text-gray-600 font-semibold tracking-tight">v{{ $page->version }}</a>
        </p>
      </div>
      <h2 class="mt-12 font-normal text-3xl sm:text-4xl text-center">A Utility-First CSS Framework<br class="hidden sm:inline-block"> for Rapid UI Development</h2>
      <div class="mt-12 sm:flex sm:justify-center">
        ...
        <a class="mt-6 sm:mt-0 mx-auto sm:mx-2 max-w-xs rounded-full text-center leading-none font-semibold block px-12 py-3 border-2 border-tailwind-teal text-tailwind-teal hover:text-white hover:border-tailwind-teal-light hover:bg-tailwind-teal-light hover:bg-tailwind-teal-light" href="https://github.com/tailwindlabs/tailwindcss">GitHub</a>
      </div>
    </div>
  </div>
</div>
...
<div class="px-6">
  ...
  <div class="mt-10 mb-16 mx-auto flex flex-wrap justify-center text-gray-700">
    <a class="block flex items-center hover:text-tailwind-teal" href="https://github.com/tailwindlabs/tailwindcss">
