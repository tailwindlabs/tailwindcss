...
import _escapeClassName from '../../util/escapeClassName'
import _nameClass from '../../util/nameClass'
...
function escapeClassName(...args) {
  return escapeCommas(_escapeClassName(...args))
}

function nameClass(...args) {
  return escapeCommas(_nameClass(...args))
}
