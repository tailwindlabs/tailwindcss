...
So here it is — Tailwind CSS v3.1! For a complete list of every fix and improvemement check out the [release notes](https://github.com/tailwindlabs/tailwindcss/releases/tag/v3.1.0), but here's the highlights:
