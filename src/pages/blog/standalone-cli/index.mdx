...
This new standalone CLI will make it easier than ever to use Tailwind no matter what environment you're working in. Give it a try and let us know what we can do to make it even better!