...
<Tab.Group as="div" className="my-6 bg-gray-800 rounded-xl dark:ring-1 dark:ring-inset dark:ring-white/10">
  ...
  <Tab.Panels>
    <Tab.Panel className="prose focus:outline-none children:!shadow-none children:bg-transparent">
      <ReactExample1 />
    </Tab.Panel>
    <Tab.Panel className="prose focus:outline-none children:!shadow-none children:bg-transparent">
      <VueExample1 />
...
<Footer>
  Ready to try it out? <a href="https://headlessui.dev">Visit the Headless UI website →</a>
</Footer>
