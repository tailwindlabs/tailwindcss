...
<p>
  ...
  <a href="#" class="underline **decoration-sky-500**">My Company, Inc</a>. Outside of
  work, I like to <a href="#" class="underline **decoration-pink-500**">watch pod-racing</a>
  and have <a href="#" class="underline **decoration-indigo-500**">light-saber</a>
  fights.
</p>
```

Learn more in the [text decoration color](/docs/text-decoration-color), [text decoration style](/docs/text-decoration-style), [text decoration thickness](/docs/text-decoration-thickness), and [text underline offset](/docs/text-decoration-offset) documentaiton.
