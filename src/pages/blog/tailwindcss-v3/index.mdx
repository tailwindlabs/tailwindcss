...
<Example>
  <div class="flex flex-col sm:flex-row justify-center gap-8 sm:gap-16">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-gray-500 font-mono text-center mb-3 dark:text-gray-400">shadow-cyan-500/50</p>
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-gray-500 font-mono text-center mb-3 dark:text-gray-400">shadow-blue-500/50</p>
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-gray-500 font-mono text-center mb-3 dark:text-gray-400">shadow-indigo-500/50</p>
...
<Example p="none">
  <div class="bg-white p-8 text-gray-900 shadow-lg max-w-md mx-auto text-sm leading-6 sm:text-base sm:leading-7 dark:bg-gray-800 dark:text-gray-200">
...
<Example>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-10 max-w-lg mx-auto">
    <div dir="ltr">
      <p class="mb-4 text-sm font-medium text-gray-500 dark:text-gray-400">Left-to-right</p>
    ...
    <div dir="rtl">
      <p class="mb-4 text-sm font-medium text-gray-500 dark:text-gray-400">Right-to-left</p>
      <div class="group flex items-center">
