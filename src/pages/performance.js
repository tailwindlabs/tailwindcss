...
function PerformanceToken({ token, parentTypes, enabled, children }) {
  if (token[0] === 'class') {
    return (
      <motion.span
        animate={{ backgroundColor: [null, 'rgba(134, 239, 172, 0.25)', 'rgba(134, 239, 172, 0)'] }}
