...
<template preview>
  <div class="mb-6">
    <p class="mb-1 text-sm text-purple-600">.list-disc</p>
  ...
  <div class="mb-6">
    <p class="mb-1 text-sm text-purple-600">.list-decimal</p>
  ...
  <div>
    <p class="mb-1 text-sm text-purple-600">.list-none (default)</p>
    <ul class="default">
      <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit</li>
      <li>Assumenda, quia temporibus eveniet a libero incidunt suscipit</li>
      <li>Quidem, ipsam illum quis sed voluptatum quae eum fugit earum</li>
