...
<template preview>
  <div class="grid grid-cols-3 divide-x divide-emerald-500">
    <div class="text-center font-extrabold text-emerald-600 px-6">1</div>
    <div class="text-center font-extrabold text-emerald-600 px-6">2</div>
    <div class="text-center font-extrabold text-emerald-600 px-6">3</div>
  </div>
</template>
...
<template preview>
  <div class="grid grid-cols-1 divide-y divide-amber-500">
    <div class="text-center font-extrabold text-amber-600 py-3">1</div>
    <div class="text-center font-extrabold text-amber-600 py-3">2</div>
    <div class="text-center font-extrabold text-amber-600 py-3">3</div>
  </div>
</template>
...
<template preview>
  <div class="flex flex-col-reverse divide-y divide-y-reverse divide-rose-400">
    <div class="text-center font-extrabold text-rose-600 py-3">1</div>
    <div class="text-center font-extrabold text-rose-600 py-3">2</div>
    <div class="text-center font-extrabold text-rose-600 py-3">3</div>
  </div>
</template>
