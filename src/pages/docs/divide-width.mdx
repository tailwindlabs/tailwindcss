...
<Example>
  <div class="grid grid-cols-3 divide-x divide-gray-200 font-mono text-white text-sm text-center font-bold leading-6 rounded-lg shadow-lg overflow-hidden">
...
<Example p="none">
  <div class="grid grid-cols-1 divide-y divide-gray-200 font-mono text-white text-sm text-center font-bold leading-6 shadow-lg overflow-hidden max-w-sm mx-auto">
    <div class="p-4 text-gray-400 bg-white">01</div>
    <div class="p-4 text-gray-400 bg-white">02</div>
    <div class="p-4 text-gray-400 bg-white">03</div>
  </div>
...
<Example p="none">
  <div class="flex flex-col-reverse divide-y divide-y-reverse divide-gray-200 font-mono text-white text-sm text-center font-bold leading-6 shadow-lg overflow-hidden max-w-sm mx-auto">
    <div class="p-4 text-gray-400 bg-white">01</div>
    <div class="p-4 text-gray-400 bg-white">02</div>
    <div class="p-4 text-gray-400 bg-white">03</div>
  </div>
