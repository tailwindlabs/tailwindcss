...
<Example p="none">
  <div class="bg-white p-8 text-gray-900 shadow-lg max-w-sm mx-auto text-sm leading-6 sm:text-base sm:leading-7 dark:bg-gray-800 dark:text-gray-400">
    <p class="text-sm leading-6">I’m Derek, an astro-engineer based in Tattooine. I like to build X-Wings at <a href="#" class="font-bold underline decoration-sky-500 decoration-2 dark:text-gray-200">My Company, Inc</a>. Outside of work, I like to <a href="#" class="font-bold underline decoration-pink-500 decoration-2 dark:text-gray-200">watch pod-racing</a> and have <a href="#" class="font-bold underline decoration-indigo-500 decoration-2 dark:text-gray-200">light-saber</a> fights.</p>
  </div>
</Example>
