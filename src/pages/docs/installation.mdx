---
title: Installation
description: Learn how get Tailwind CSS up and running in your project.
---
...
We've put together a bunch of guides to help you get Tailwind up and running with your favorite tools as fast as possible.

- [Angular](/docs/guides/angular)
- [Create React App](/docs/guides/create-react-app)
- [Gatsby](/docs/guides/gatsby)
- [Laravel](/docs/guides/laravel)
- [Next.js](/docs/guides/nextjs)
- [Nuxt.js](/docs/guides/nuxtjs)
- [Rails](/docs/guides/rails)
- [Vue 3](/docs/guides/vue-3-vite)

If we're missing a guide for your framework of choice have no fear, our [general installation instructions](#installing-tailwind-as-a-postcss-plugin) will get you set up in no time.
...
When building for production, be sure to read our separate guide on [optimizing for production](/docs/optimizing-for-production) to learn about tree-shaking unused styles for best performance.
...
```bash
npx tailwindcss build ./src/tailwind.css -c ./.config/tailwind.config.js -o ./dist/tailwind.css
```
...
```bash
NODE_ENV=production npx tailwindcss build ./src/tailwind.css -o ./dist/tailwind.css
```
...
To get the most out of Tailwind, you really should [install it as a PostCSS plugin](#install-tailwind-as-a-postcss-plugin).
