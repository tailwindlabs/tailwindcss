...
```shell
npx -p postcss -p autoprefixer -c "tailwindcss build -o tailwind.css"
```
...
```shell
npx -p postcss -p autoprefixer -c "tailwindcss build ./src/tailwind.css -o ./dist/tailwind.css"
```
...
```shell
npx -p postcss -p autoprefixer -c "tailwindcss build ./src/tailwind.css -c ./.config/tailwind.config.js -o ./dist/tailwind.css"
```
...
```shell
NODE_ENV=production npx -p postcss -p autoprefixer -c "tailwindcss build ./src/tailwind.css -o ./dist/tailwind.css"
```
