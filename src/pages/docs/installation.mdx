...
If we're missing a guide for your framework of choice have no fear, our [general installation instructions](#installing-tailwind-as-a-post-css-plugin) will get you set up in no time.
...
In this case, you should [install the PostCSS 7 compatibility build](#postcss-7-compatibility-build) instead.
...
In this case, you should [switch to our PostCSS 7 compatibility build](#postcss-7-compatibility-build) instead.
