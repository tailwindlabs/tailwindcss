...
<template preview>
  <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
    <div class="shadow-xs h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow-xs</div>
    <div class="shadow-sm h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow-sm</div>
    <div class="shadow h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow</div>
    <div class="shadow-md h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow-md</div>
    <div class="shadow-lg h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow-lg</div>
    <div class="shadow-xl h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow-xl</div>
    <div class="shadow-2xl h-32 w-32 font-semibold bg-white rounded-md flex items-center justify-center">.shadow-2xl</div>
  </div>
</template>
...
<template preview>
  <div class="flex justify-center items-center">
    <div class="shadow-inner h-24 w-40 font-semibold bg-gray-200 rounded-md flex items-center justify-center">.shadow-inner</div>
  </div>
</template>
...
<template preview>
  <div class="flex justify-center items-center">
    <div class="shadow-none h-24 w-40 font-semibold bg-gray-200 rounded-md flex items-center justify-center">.shadow-none</div>
  </div>
</template>
