...
<template preview class="p-4 px-8">
  <div class="mb-6">
    ...
    <ul class="list-disc list-inside bg-light-blue-200 bg-stripes bg-stripes-white text-gray-600 py-2 rounded-md">
  ...
  <div class="mb-6">
    ...
    <ul class="list-disc list-outside bg-light-blue-200 bg-stripes bg-stripes-white text-gray-600 py-2 rounded-md">
      <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit</li>
      <li>Assumenda, quia temporibus eveniet a libero incidunt suscipit</li>
      <li>Quidem, ipsam illum quis sed voluptatum quae eum fugit earum</li>
    </ul>
