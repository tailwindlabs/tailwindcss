...
```html emerald
<template preview>
  <p class="normal-case text-xl text-emerald-600 lg:text-2xl">The quick brown fox jumped over the lazy dog.</p>
</template>
...
```html purple
<template preview>
  <p class="uppercase text-xl text-purple-600 lg:text-2xl">The quick brown fox jumped over the lazy dog.</p>
</template>
...
```html rose
<template preview>
  <p class="lowercase text-xl text-rose-600 lg:text-2xl">The quick brown fox jumped over the lazy dog.</p>
</template>
...
```html fuchsia
<template preview>
  <p class="capitalize text-xl text-fuchsia-600 lg:text-2xl">The quick brown fox jumped over the lazy dog.</p>
</template>
