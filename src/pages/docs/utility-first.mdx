...
- **Hover, focus, and other states**. Inline styles can't target states like hover or focus, but Tailwind's [state variants](/docs/pseudo-class-variants) make it easy to style those states with utility classes.
  ...
  <div class="max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
    <div class="sm:flex sm:items-center px-6 py-4">
      ...
      <div class="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
        <p class="text-gray-900 font-bold text-xl leading-tight">
          Erin Lindford
        </p>
        ...
        <div class="mt-4">
          <button class="text-purple-700 hover:text-white hover:bg-purple-600 border border-purple-600 text-xs font-semibold rounded-full px-4 py-1 leading-normal">Message</button>
        </div>
      </div>
    </div>
  </div>
