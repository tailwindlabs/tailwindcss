...
This is easily solved by [extracting components](/docs/reusing-styles), usually as template partials or components.
...
<Example>
  <div class="text-center">
    <button type="button" class="py-2 px-4 bg-sky-500 text-white font-semibold rounded-lg shadow-md hover:bg-sky-700 focus:outline-none" tabindex="-1">
      Save changes
    </button>
  </div>
</Example>
