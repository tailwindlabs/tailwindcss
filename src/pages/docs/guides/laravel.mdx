...
Open the `./resources/css/app.css` file included with a new Laravel project and use the `@tailwind` directive to include Tailwind's `base`, `components`, and `utilities` styles.
