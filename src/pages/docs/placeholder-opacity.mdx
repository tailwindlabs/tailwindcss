...
<template preview>
  <div class="space-y-4">
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-100 border rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:shadow-outline" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-75 border rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:shadow-outline" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-50 border rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:shadow-outline" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-25 border rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:shadow-outline" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-0 border rounded-md w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none focus:shadow-outline" placeholder="jane@example.com">
    </div>
  </div>
</template>
