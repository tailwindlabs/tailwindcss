...
<Example p="none">
  <div class="overflow-x-scroll sm:overflow-x-visible px-4">
    <div class="mx-auto max-w-sm bg-white shadow-xl p-8 text-gray-500">
      <p class="break-normal">The longest word in any of the major English language dictionaries is
      <span class="text-gray-900 font-medium">pneumonoultramicroscopicsilicovolcanoconiosis,</span>
