...
```html lightBlue
<template preview>
  <p class="break-normal max-w-xs p-4 mx-auto bg-light-blue-200 rounded-md shadow-inner">
...
```html amber
<template preview>
  <p class="break-words max-w-xs p-4 mx-auto bg-amber-200 rounded-md shadow-inner">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiisitaquequodpraesentiumexplicaboincidunt? Dolores beatae nam at sed dolorum ratione dolorem nisi velit cum.
  </p>
</template>
...
```html emerald
<template preview>
  <p class="break-all max-w-xs p-4 mx-auto bg-emerald-200 rounded-md shadow-inner">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiisitaquequodpraesentiumexplicaboincidunt? Dolores beatae nam at sed dolorum ratione dolorem nisi velit cum.
  </p>
</template>
