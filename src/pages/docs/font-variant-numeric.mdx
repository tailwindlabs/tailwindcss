...
<Example>
  <p class="font-source ordinal text-center text-gray-700 text-lg">1st</p>
</Example>
...
<Example>
  <p class="font-source slashed-zero text-center text-gray-700 text-lg">0</p>
</Example>
...
<Example>
  <p class="font-source lining-nums text-center text-gray-700 text-lg">1234567890</p>
</Example>
...
<Example>
  <p class="font-source oldstyle-nums text-center text-gray-700 text-lg">1234567890</p>
</Example>
...
<Example>
  <div class="max-w-sm text-right">
    <p class="font-source proportional-nums text-gray-700 text-lg">12121</p>
    <p class="font-source proportional-nums text-gray-700 text-lg">90909</p>
  </div>
</Example>
...
<Example>
  <div class="max-w-sm text-right">
    <p class="font-source tabular-nums text-gray-700 text-lg">12121</p>
    <p class="font-source tabular-nums text-gray-700 text-lg">90909</p>
  </div>
</Example>
...
<Example>
  <p class="font-source diagonal-fractions text-center text-gray-700 text-lg">1/2 3/4 5/6</p>
</Example>
...
<Example>
  <p class="font-ubuntu-mono stacked-fractions text-center text-gray-700 text-lg">1/2 3/4 5/6</p>
</Example>
