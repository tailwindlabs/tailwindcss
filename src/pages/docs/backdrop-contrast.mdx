...
import utilities from 'utilities?plugin=backdropContrast'
...
<Example p="none">
  ...
  <div class="flex items-center justify-around gap-6 sm:gap-4 font-mono font-bold shrink-0 p-8">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">backdrop-contrast-50</p>
      <div class="relative">
        <div class="absolute inset-6 backdrop-contrast-50 h-20 w-20 bg-white/30"></div>
    ...
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">backdrop-contrast-125</p>
      <div class="relative">
        <div class="absolute inset-6 backdrop-contrast-125 h-20 w-20 bg-white/30"></div>
        <img class="w-32 h-32 object-cover rounded-lg shadow-xl" src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&h=320&q=80" />
        <div class="absolute inset-0 ring-1 ring-inset ring-black/10 rounded-lg"></div>
      </div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">backdrop-contrast-200</p>
      <div class="relative">
        <div class="absolute inset-6 backdrop-contrast-200 h-20 w-20 bg-white/30"></div>
        <img class="w-32 h-32 object-cover rounded-lg shadow-xl" src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&h=320&q=80" />
        <div class="absolute inset-0 ring-1 ring-inset ring-black/10 rounded-lg"></div>
      </div>
    </div>
...
<RemovingBackdropFilters defaultClass="backdrop-blur-md backdrop-contrast-125" />
...
<HoverFocusAndOtherStates defaultClass="backdrop-contrast-125" featuredClass="backdrop-contrast-150" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="backdrop-contrast-125" featuredClass="backdrop-contrast-150" />
...
<ArbitraryValues property="backdrop-contrast" featuredClass="backdrop-contrast-[.25]" />
