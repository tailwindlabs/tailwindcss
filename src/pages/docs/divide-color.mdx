...
<Example p="none">
  <div class="grid grid-cols-1 divide-y-4 divide-gray-400/25 font-mono text-white text-sm text-center font-bold leading-6 shadow-lg overflow-hidden max-w-sm mx-auto">
...
```html
<div class="divide-y-4 divide-gray-400**/[.24]** ...">
  <!-- ... -->
</div>
```
