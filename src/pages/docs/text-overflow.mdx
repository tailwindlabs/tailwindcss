...
```html indigo
<template preview>
  <p class="max-w-xs p-4 mx-auto truncate bg-indigo-200 rounded-md shadow-inner">
...
```html emerald
<template preview>
  <p class="max-w-xs p-4 mx-auto overflow-ellipsis overflow-hidden bg-emerald-200 rounded-md shadow-inner">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiisitaquequodpraesentiumexplicaboincidunt? Dolores beatae nam at sed dolorum ratione dolorem nisi velit cum.
  </p>
</template>
...
```html lightBlue
<template preview>
  <p class="max-w-xs p-4 mx-auto overflow-clip overflow-hidden bg-light-blue-200 rounded-md shadow-inner">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiisitaquequodpraesentiumexplicaboincidunt? Dolores beatae nam at sed dolorum ratione dolorem nisi velit cum.
  </p>
</template>
