...
```html emerald
<template preview>
  <p class="italic text-xl text-emerald-600 lg:text-2xl">The quick brown fox jumped over the lazy dog.</p>
</template>
...
```html amber
<template preview>
  <p class="not-italic text-xl text-amber-600 lg:text-2xl">The quick brown fox jumped over the lazy dog.</p>
</template>
