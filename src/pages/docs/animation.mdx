...
<Example>
  <div class="flex items-center justify-center">
    <span class="relative inline-flex">
      <button type="button" class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-sky-500 bg-white transition ease-in-out duration-150 cursor-not-allowed ring-1 ring-gray-900/10" disabled>
        Transactions
      </button>
...
<Example>
  <div class="flex items-center justify-center">
    <div class="bg-white p-4 ring-1 ring-gray-900/5 rounded-lg shadow-lg max-w-xs w-full h-28">
...
<Example>
  <div class="flex justify-center">
    <div class="animate-bounce bg-white p-2 w-10 h-10 ring-1 ring-gray-900/5 shadow-lg rounded-full flex items-center justify-center">
