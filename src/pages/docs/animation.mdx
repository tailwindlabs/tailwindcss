  ...
  custom: (
    <table className="w-full text-left border-collapse">
      ...
      <tbody className="align-baseline">
        <tr>
          <td translate="no" className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-sky-500 whitespace-nowrap">
            animate-none
          </td>
        ...
        <tr>
          <td translate="no" className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-sky-500 whitespace-nowrap border-t border-gray-100">
            animate-spin
          </td>
