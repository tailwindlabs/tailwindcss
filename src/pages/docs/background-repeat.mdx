...
```html fuchsia
<template preview>
  <div class="w-full bg-fuchsia-300 h-48 bg-repeat" style="background-image:url('/img/placeholder-fuchsia.svg');">
  </div>
</template>
...
```html indigo
<template preview>
  <div class="w-full bg-indigo-200 h-48 bg-center bg-repeat-y" style="background-image:url('/img/placeholder-indigo.svg');">
  </div>
</template>
