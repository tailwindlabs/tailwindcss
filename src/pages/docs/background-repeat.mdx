...
```html fuchsia
<template preview>
  <div class="w-full bg-fuchsia-300 h-48 bg-center bg-repeat" style="background-image:url('/img/placeholder-light-blue.svg');">
  </div>
</template>
...
```html rose
<template preview>
  <div class="w-full bg-rose-300 h-48 bg-center bg-no-repeat" style="background-image:url('/img/placeholder-light-blue.svg');">
  </div>
</template>
...
```html purple
<template preview>
  <div class="w-full bg-purple-300 h-48 bg-center bg-repeat-x" style="background-image:url('/img/placeholder-light-blue.svg');">
  </div>
</template>
...
```html indigo
<template preview>
  <div class="w-full bg-indigo-300 h-48 bg-center bg-repeat-y" style="background-image:url('/img/placeholder-light-blue.svg');">
  </div>
</template>
