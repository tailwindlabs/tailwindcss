...
<Example p="none">
  <div class="grid grid-cols-1 divide-dashed divide-y font-mono text-white text-sm text-center font-bold leading-6 shadow-lg overflow-hidden max-w-sm mx-auto">
