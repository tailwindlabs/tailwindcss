...
<template preview>
    <div class="flex justify-around items-end space-between-3">
        ...
        <div>
            <div class="h-12 w-12 rounded-md bg-indigo-500 text-white text-2xl font-extrabold"></div>
            <p class="text-center mt-2 text-sm text-indigo-600">h-12</p>
        </div>
        <div>
            <div class="h-16 w-16 rounded-md bg-indigo-500 text-white text-2xl font-extrabold"></div>
