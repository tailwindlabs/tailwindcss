...
```html lightBlue
<template preview>
  <p class="font-sans text-xl text-light-blue-600 text-center md:text-2xl">
...
```html emerald
<template preview>
  <p class="font-serif text-xl text-emerald-600 text-center md:text-2xl">
    The quick brown fox jumps over the lazy dog.
  </p>
</template>
...
```html indigo
<template preview>
  <p class="font-mono text-xl text-indigo-600 text-center md:text-2xl">
    The quick brown fox jumps over the lazy dog.
  </p>
</template>
