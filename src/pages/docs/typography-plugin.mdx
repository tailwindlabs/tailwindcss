  ...
  theme: {
    extend: {
      typography: ({ theme }) => ({
        pink: {
          css: {
            '--tw-prose-body': colors.pink[800],
            '--tw-prose-headings': colors.pink[900],
            '--tw-prose-lead': colors.pink[700],
            '--tw-prose-links': colors.pink[900],
            '--tw-prose-bold': colors.pink[900],
            '--tw-prose-counters': colors.pink[600],
            '--tw-prose-bullets': colors.pink[400],
            '--tw-prose-hr': colors.pink[300],
            '--tw-prose-quotes': colors.pink[900],
            '--tw-prose-quote-borders': colors.pink[300],
