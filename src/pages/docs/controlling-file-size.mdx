...
If you really want to remove _all_ unused styles, use the `preserveHtmlElements: false` option and **be very careful** to provide the paths to _all_ files that might reference any classes or HTML elements:
