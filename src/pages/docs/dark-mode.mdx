...
<div class="bg-white **dark:bg-gray-900**">
  ...
  <p class="text-gray-700 **dark:text-gray-300**">
    Ratione praesentium numquam. Laudantium porro deserunt assumenda labore in et architecto sit minus. Et expedita eum rerum recusandae. Vel assumenda iste officiis modi ut. Doloremque repudiandae perspiciatis qui natus officiis qui suscipit et dolores. Odit sit cumque sit excepturi iusto ut ipsa impedit.
  </p>
</div>
```
