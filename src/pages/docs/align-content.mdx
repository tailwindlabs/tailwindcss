...
<Example>
  <div class="font-mono text-white text-sm font-bold leading-6">
    <div class="grid grid-cols-3 gap-4 content-center w-full rounded-lg bg-stripes-light-blue text-center h-56">
      <div class="p-4 shadow-lg rounded-lg bg-light-blue-500">01</div>
      <div class="p-4 shadow-lg rounded-lg bg-light-blue-500">02</div>
      <div class="p-4 shadow-lg rounded-lg bg-light-blue-500">03</div>
      <div class="p-4 shadow-lg rounded-lg bg-light-blue-500">04</div>
      <div class="p-4 shadow-lg rounded-lg bg-light-blue-500">05</div>
    </div>
  </div>
</Example>
...
<HoverFocusAndOtherStates defaultClass="content-start" featuredClass="content-around" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="content-start" featuredClass="content-around" />
