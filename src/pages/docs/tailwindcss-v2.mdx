...
description: The best CSS framework we've ever made, available today.
---

import colorsImage from '@/img/announcement-tailwind-colors.jpg'
import graysImage from '@/img/announcement-tailwind-grays.jpg'
...
<div className="relative" style={{paddingBottom: '56.25%'}}>
  <iframe className="absolute inset-0 h-full w-full" src="https://www.youtube.com/embed/3u_vIdnJYLc" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
</div>
...
- [**Extra wide 2XL breakpoint**](#extra-wide-2xl-breakpoint), for designing at 1536px and above
...
- [**Incompatibility with IE11**](#incompatibility-with-ie11), so you can tell the man upstairs _"sorry boss it's out of my hands, blame Tailwind"_
...
<template preview class="p-6">
  <div class="rounded-lg bg-gray-50 h-32"></div>
</template>
