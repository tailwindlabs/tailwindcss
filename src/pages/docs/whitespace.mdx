...
```html indigo
<template preview>
  <div class="w-3/4 p-6 bg-indigo-300 rounded-md shadow-inner">
    <div class="whitespace-normal font-flow text-indigo-600 text-3xl leading-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quidem itaque beatae, rem tenetur quia iure,
...
```html emerald
<template preview>
  <div class="w-3/4 p-6 bg-emerald-300 rounded-md shadow-inner overflow-x-auto">
    <div class="whitespace-nowrap font-flow text-emerald-600 text-3xl leading-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quidem itaque beatae, rem tenetur quia iure,
      eum natus enim maxime
      laudantium quibusdam illo nihil,
...
```html amber
<template preview>
  <div class="w-3/4 p-6 bg-amber-300 rounded-md shadow-inner overflow-x-auto">
    <div class="whitespace-pre font-flow text-amber-600 text-3xl leading-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quidem itaque beatae, rem tenetur quia iure,
      eum natus enim maxime
      laudantium quibusdam illo nihil,
...
```html lightBlue
<template preview>
  <div class="w-3/4 p-6 bg-light-blue-300 rounded-md shadow-inner">
    <div class="whitespace-pre-line font-flow text-light-blue-600 text-3xl leading-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quidem itaque beatae, rem tenetur quia iure,
      eum natus enim maxime
      laudantium quibusdam illo nihil,
...
```html rose
<template preview>
  <div class="w-3/4 p-6 bg-rose-300 rounded-md shadow-inner">
    <div class="whitespace-pre-wrap font-flow text-rose-600 text-3xl leading-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis quidem itaque beatae, rem tenetur quia iure,
      eum natus enim maxime
      laudantium quibusdam illo nihil,
