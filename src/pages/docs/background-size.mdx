...
```html amber
<template preview>
  <div class="w-full bg-amber-200 h-80 bg-auto bg-no-repeat bg-center" style="background-image:url('/img/placeholder-amber.svg');">
  </div>
</template>
...
```html emerald
<template preview>
  <div class="w-full mx-auto bg-emerald-200 h-80 bg-center bg-cover" style="background-image:url('/img/placeholder-emerald.svg');">
  </div>
</template>
