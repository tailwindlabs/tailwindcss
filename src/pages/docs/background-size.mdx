...
```html amber
<template preview>
  <div class="w-full bg-amber-200 h-48 bg-center bg-auto" style="background-image:url('https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80');">
  </div>
</template>
...
```html emerald
<template preview>
  <div class="w-full mx-auto bg-emerald-200 h-48 bg-center bg-cover" style="background-image:url('/img/placeholder-emerald.svg');">
  </div>
</template>
