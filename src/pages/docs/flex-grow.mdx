...
<Example resizable>
  <div class="flex gap-4 text-white text-sm font-bold font-mono leading-6 bg-stripes-indigo rounded-lg">
    <div class="w-14 h-14 flex-none rounded-lg flex items-center justify-center bg-indigo-300">
      01
    </div>
    <div class="p-4 grow rounded-lg flex items-center justify-center bg-indigo-500 shadow-lg">
      02
    </div>
    <div class="p-4 w-14 h-14 flex-none rounded-lg flex items-center justify-center bg-indigo-300">
      03
    </div>
  </div>
</Example>
...
<Example resizable>
  <div class="flex gap-4 text-white text-sm font-bold font-mono leading-6 bg-stripes-pink rounded-lg">
    <div class="p-4 grow rounded-lg flex items-center justify-center bg-pink-300">
      01
    </div>
    <div class="shrink-0 w-14 h-14 grow-0 rounded-lg flex items-center justify-center bg-pink-500 shadow-lg">
      02
    </div>
    <div class="p-4 grow rounded-lg hidden md:flex items-center justify-center bg-pink-300">
      03
    </div>
  </div>
</Example>
