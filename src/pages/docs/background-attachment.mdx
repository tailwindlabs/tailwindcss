...
```html lightBlue
<template preview>
  <div class="w-full h-48 bg-fixed bg-cover bg-center overflow-y-scroll" style="background-image:url('/img/placeholder-light-blue.svg');">
    <div class="h-64"></div>
  </div>
</template>
...
```html indigo
<template preview>
  <div class="w-full h-48 bg-local bg-cover bg-center overflow-y-scroll" style="background-image:url('/img/placeholder-indigo.svg');">
    <div class="h-64"></div>
  </div>
</template>
...
```html fuchsia
<template preview>
  <div class="w-full h-48 bg-scroll bg-cover bg-center overflow-y-scroll" style="background-image:url('/img/placeholder-fuchsia.svg');">
    <div class="h-64"></div>
  </div>
</template>
