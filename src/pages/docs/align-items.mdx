...
<Example>
  <div class="font-mono text-white text-sm font-bold leading-6">
    <div class="flex items-end gap-4 w-full rounded-lg bg-stripes-light-blue text-center">
      <div class="py-4 flex-1 flex items-center justify-center shadow-lg rounded-lg bg-light-blue-500">01</div>
      <div class="py-12 flex-1 flex items-center justify-center shadow-lg rounded-lg bg-light-blue-500">02</div>
      <div class="py-8 flex-1 flex items-center justify-center shadow-lg rounded-lg bg-light-blue-500">03</div>
    </div>
  </div>
</Example>
...
<HoverFocusAndOtherStates defaultClass="items-stretch" featuredClass="items-center" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="items-stretch" featuredClass="items-center" />
