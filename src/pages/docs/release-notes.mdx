...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Oct 12, 2020</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Sep 4, 2020</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Aug 18, 2020</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>July 28, 2020</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>July 15, 2020</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Apr 29, 2020</div>

Tailwind CSS v1.4 is out now with a couple of major new features:

- [New color opacity utilities](/docs/background-opacity)
- [Built-in PurgeCSS support](/docs/optimizing-for-production)
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Apr 21, 2020</div>
...
- [New group-focus variant](/docs/hover-focus-and-other-states#group-focus)
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Feb 5, 2020</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>Aug 6, 2019</div>
...
<div className="font-medium" style={{ marginTop: '-1.5rem' }}>May 13, 2019</div>
