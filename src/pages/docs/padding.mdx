...
<template preview>
  <div class="flex flex-wrap items-start justify-center text-white font-mono -mx-5">
    <div class="mx-5 bg-rose-500 stripes stripes-white rounded-md overflow-hidden pt-6">
      <div class="bg-rose-500 flex items-center justify-center py-3 px-4">
        pt-6
      </div>
    </div>
    <div class="mx-5 bg-rose-500 stripes stripes-white rounded-md overflow-hidden pr-4 mt-6">
      <div class="bg-rose-500 flex items-center justify-center py-3 px-4">
        pr-4
      </div>
    </div>
    <div class="mx-5 bg-rose-500 stripes stripes-white rounded-md overflow-hidden pb-8 mt-6">
      <div class="bg-rose-500 flex items-center justify-center py-3 px-4">
        pb-8
      </div>
    </div>
    <div class="mx-5 bg-rose-500 stripes stripes-white rounded-md overflow-hidden pl-2 mt-6">
      <div class="bg-rose-500 flex items-center justify-center py-3 px-4">
        pl-2
      </div>
    </div>
...
<template preview>
  <div class="flex justify-center text-white font-mono">
    <div class="bg-emerald-500 stripes stripes-white rounded-md overflow-hidden px-8">
...
<template preview>
  <div class="flex justify-center text-white font-mono">
    <div class="bg-indigo-500 stripes stripes-white rounded-md overflow-hidden py-8">
...
<template preview>
  <div class="flex justify-center text-white font-mono">
    <div class="bg-fuchsia-500 stripes stripes-white rounded-md overflow-hidden p-8">
