...
```html emerald
<template preview>
  <div class="text-center text-xl text-emerald-600 lg:text-2xl">
...
<template preview>
  <div class="max-w-xs w-full mx-auto">
    <input class="bg-white font-normal focus:font-bold focus:shadow-outline text-yellow-900 appearance-none inline-block w-full border border-yellow-400 rounded py-3 px-4 focus:outline-none" value="Focus me" placeholder="Focus me">
  </div>
</template>
