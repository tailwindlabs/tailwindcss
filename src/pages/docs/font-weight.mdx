...
<Example>
  <div class="flex flex-col gap-8">
    <div>
      ...
      <p class="font-light text-lg text-gray-900 dark:text-gray-200">
    ...
    <div>
      ...
      <p class="font-medium text-lg text-gray-900 dark:text-gray-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
    <div>
    ...
    <div>
      ...
      <p class="font-bold text-lg text-gray-900 dark:text-gray-200">
        The quick brown fox jumps over the lazy dog.
      </p>
    </div>
  </div>
