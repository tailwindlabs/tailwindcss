...
Presets can also be defined as a function so that you can passthrough configuration if your preset requires that.
...
The `presets` section is where you can include other configurations, this is useful if you have some configuration abstracted for your company. We have a [YouTube video](https://www.youtube.com/watch?v=AaZhspn7-MM) on this very subject.

The presets can be an array, if you don't have any presets defined, then you will inherit the default theme. If you have one or more presets defined then the default configuration will not be included. Each preset can also have its own presets.
