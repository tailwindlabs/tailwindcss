...
Wrapping any custom CSS in a `@layer` directive also tells Tailwind to consider those styles for purging when purging that layer. Read our [Controlling File Size](/docs/controlling-file-size) documentation for more details.
