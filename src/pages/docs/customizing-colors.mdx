...
Tailwind includes an expertly-crafted default color palette that is a great starting point if you don't have your own branding ready to go, but for most projects the color palette is the first thing you'll want to customize.
