...
When it comes to building a custom color palette, you can either [configure your own custom colors](#custom-colors) from scratch if you know exactly what you want, or [curate your colors](#curating-colors) from our extensive included color palette if you want a head start.
...
By default, these colors will be made available everywhere in the framework where you use colors, like the [text color](/docs/text-color) utilities, [border color](/docs/border-color) utilities, [background color](/docs/text-color) utilities, and more.
