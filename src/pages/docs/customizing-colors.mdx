...
Since version v2.x you can also have a deeply nested object, the colors will be fattened.
...
module.exports = {
  theme: {
    colors: {
      primary: {
        indigo: {
          lighter: '#b3bcf5', // text-primary-indigo-lighter, ...
          DEFAULT: '#5c6ac4', // text-primary-indigo, ...
          dark: '#202e78',    // text-primary-indigo-dark, ...
        }
      }
    }
  }
