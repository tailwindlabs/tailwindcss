...
<details className="-mt-0 mb-6 rounded-xl border px-6 py-3 prose open:pb-5 dark:prose-dark dark:border-gray-800">
  <summary className="font-medium cursor-default select-none text-gray-900 dark:text-gray-200">Why does Tailwind group styles into "layers"?</summary>
