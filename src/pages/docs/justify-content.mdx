...
<HoverFocusAndOtherStates defaultClass="justify-start" featuredClass="justify-between" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="justify-start" featuredClass="justify-between" />
