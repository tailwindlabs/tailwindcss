...
<template preview class="bg-white p-8">
  <div class="grid grid-cols-6 gap-4">
    <div class="col-start-2 col-span-4 bg-amber-500 h-12 rounded-md flex items-center justify-center text-white text-2xl font-extrabold">1</div>
    <div class="col-start-1 col-end-3 bg-amber-500 h-12 rounded-md flex items-center justify-center text-white text-2xl font-extrabold">2</div>
    <div class="col-end-7 col-span-2 bg-amber-500 h-12 rounded-md flex items-center justify-center text-white text-2xl font-extrabold">3</div>
    <div class="col-start-1 col-end-7 bg-amber-500 h-12 rounded-md flex items-center justify-center text-white text-2xl font-extrabold">4</div>
  </div>
</template>
