...
<template preview>
  <div class="flex justify-center space-x-8">
    <button type="button" class="py-2 px-4 bg-rose-500 text-white font-semibold rounded-lg shadow-md hover:bg-rose-700 focus:outline-none focus:bg-rose-500 focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 focus:ring-opacity-75 focus:ring-transparent">
      Ring on focus
    </button>
    <button type="button" class="py-2 px-4 bg-rose-500 text-white font-semibold rounded-lg shadow-md hover:bg-rose-700 focus:outline-none focus:bg-rose-500 focus-visible:ring-2 focus-visible:ring-rose-500 focus-visible:ring-offset-2 focus-visible:ring-opacity-75 focus-visible:ring-transparent">
      Ring on focus-visible
    </button>
  </div>
</template>

<button class="**focus:ring-2 focus:ring-rose-500** ...">
  Ring on focus
</button>
...
<template preview>
  <div class="p-4 max-w-xs mx-auto bg-white rounded-xl shadow-md">
    <label class="flex items-center space-x-3">
      <input type="checkbox" name="checked-demo" value="1" class="form-tick appearance-none h-6 w-6 border border-gray-300 rounded-md checked:bg-light-blue-600 checked:border-transparent focus:outline-none">
      <span class="text-gray-900 font-medium">Option 1</span>
    </label>
  </div>
</template>

<input type="checkbox" class="appearance-none **checked:bg-blue-light-600 checked:border-transparent** ...">
```
...
<template preview class="p-6">
  <div class="bg-white rounded-xl shadow-md overflow-hidden">
    <div class="px-6 py-4 border-t first:border-t-0">One</div>
    <div class="px-6 py-4 border-t first:border-t-0">Two</div>
    <div class="px-6 py-4 border-t first:border-t-0">Three</div>
  </div>
</template>
...
<template preview class="p-6">
  <div class="bg-white rounded-xl shadow-md overflow-hidden">
    <div class="px-6 py-4 border-b last:border-b-0">One</div>
    <div class="px-6 py-4 border-b last:border-b-0">Two</div>
    <div class="px-6 py-4 border-b last:border-b-0">Three</div>
  </div>
</template>

<div class="rounded-xl ...">
  <div v-for="item in items" class="border-t **last:border-b-0** ...">
    {{ item }}
  </div>
</div>
```
...
```html rose
<template preview class="p-6">
  <div class="bg-white rounded-xl shadow-md overflow-hidden divide-y divide-gray-200">
    <div class="px-6 py-4 odd:bg-gray-100">One</div>
    <div class="px-6 py-4 odd:bg-gray-100">Two</div>
    <div class="px-6 py-4 odd:bg-gray-100">Three</div>
  </div>
</template>

<div class="rounded-xl ...">
  <div v-for="item in items" class="**odd:bg-gray-100** ...">
    {{ item }}
  </div>
</div>
```
...
<template preview class="p-6">
  <div class="bg-white rounded-xl shadow-md overflow-hidden divide-y divide-gray-200">
    <div class="px-6 py-4 even:bg-gray-100">One</div>
    <div class="px-6 py-4 even:bg-gray-100">Two</div>
    <div class="px-6 py-4 even:bg-gray-100">Three</div>
  </div>
</template>

<div class="rounded-xl ...">
  <div v-for="item in items" class="**even:bg-gray-100** ...">
    {{ item }}
  </div>
</div>
```
