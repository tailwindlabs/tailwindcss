...
export const classes = {
  ...
  transformProperties: ({ selector, properties }) => {
    ...
    delete properties['--ring-inset']
    delete properties['--ring-offset-width']
    delete properties['--ring-offset-color']
    delete properties['--ring-color']
    delete properties['--ring-offset-shadow']
    delete properties['box-shadow']
    properties['box-shadow'] = properties['--ring-shadow']
    delete properties['--ring-shadow']
    return properties
  }
}
