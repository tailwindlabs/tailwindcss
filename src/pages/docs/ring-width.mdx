...
<Example>
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-white text-center font-bold leading-6 text-white">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-gray-500 font-mono text-center mb-3">ring-2</p>
      <button class="px-4 py-2 font-semibold text-sm bg-white text-gray-700 border border-gray-300 rounded-md shadow-sm ring-2 ring-offset-2 ring-offset-gray-50 ring-blue-300">Button A</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-gray-500 font-mono text-center mb-3">ring</p>
        <button class="px-4 py-2 font-semibold text-sm bg-white text-gray-700 border border-gray-300 rounded-md shadow-sm ring ring-offset-2 ring-offset-gray-50 ring-blue-300">Button B</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-gray-500 font-mono text-center mb-3">ring-4</p>
      <button class="px-4 py-2 font-semibold text-sm bg-white text-gray-700 border border-gray-300 rounded-md shadow-sm ring-4 ring-offset-2 ring-offset-gray-50 ring-blue-300">Button C</button>
    </div>
  </div>
</Example>
...
<Example hint="Focus this button to see the ring appear">
  <div class="flex justify-center max-w-md mx-auto gap-4 text-white text-sm text-center font-bold leading-6 text-white">
    <button class="px-4 py-2 font-semibold text-sm bg-white text-gray-700 border border-gray-300 rounded-md shadow-sm ring-violet-300 ring-offset-2 ring-offset-gray-50 focus:outline-none focus:ring-2">Save Changes</button>
  </div>
</Example>
...
<Example>
  <div class="flex justify-center max-w-md mx-auto gap-4 text-white text-sm text-center font-bold leading-6 text-white">
    <button class="px-4 py-2 font-semibold text-sm bg-white text-gray-700 rounded-md shadow-sm ring-pink-300 ring-2 ring-inset">Save Changes</button>
  </div>
</Example>
