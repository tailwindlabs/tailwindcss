...
<template preview>
  <div class="h-32 overflow-hidden">
    <div class="overflow-visible h-24 px-6 py-2 rounded-md border-4 border-light-blue-500">
      <p class="md:w-2/3 lg:w-1/2 font-flow leading-5 text-light-blue-900">
...
```html rose
<template preview>
  <div class="overflow-auto h-32 rounded-md border-4 border-rose-500">
    <p class="font-flow leading-5 text-rose-900 px-6 py-4">
