...
<Example hint="Try clicking the search icons to see the expected behaviour">
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-10 px-0 sm:px-10 font-mono font-bold">
    <div class="flex flex-col">
      <p class="font-medium text-sm text-gray-500 font-mono mb-3 dark:text-gray-400">pointer-events-auto</p>
      <div class="relative rounded-lg shadow-sm w-full">
        ...
        <input type="text" placeholder="Search" class="font-sans block text-sm w-full pl-10 py-2 px-3 ring-1 ring-gray-900/10 text-gray-500 rounded-lg dark:bg-gray-800 dark:ring-0 dark:highlight-white/5 dark:text-gray-400" />
      </div>
    </div>
    <div class="flex flex-col">
      <p class="font-medium text-sm text-gray-500 font-mono mb-3 dark:text-gray-400">pointer-events-none</p>
      <div class="relative rounded-lg shadow-sm w-full">
