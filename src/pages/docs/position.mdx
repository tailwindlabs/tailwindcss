...
<Example p="none">
  <div class="px-3">
    <div class="relative max-w-md mx-auto bg-white dark:bg-gray-800 shadow-lg h-80 overflow-hidden ring-1 ring-gray-900/5">
      <div class="absolute top-0 left-0 right-0 px-4 py-3 flex items-center font-semibold text-sm text-gray-900 dark:text-gray-200 bg-gray-50/90 dark:bg-gray-700/90 backdrop-blur-sm ring-1 ring-gray-900/10 dark:ring-black/10">Contacts</div>
      <div class="overflow-auto flex flex-col divide-y h-80 dark:divide-gray-200/5">
        ...
        <div class="flex items-center gap-4 p-4">
          ...
          <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Mindy Albrect</strong>
        </div>
        <div class="flex items-center gap-4 p-4">
          ...
          <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">David Arnold</strong>
        </div>
      </div>
    </div>
  </div>
...
<Example p="none">
  <div class="px-3">
    <div class="relative max-w-md mx-auto bg-white dark:bg-gray-800 shadow-lg h-80 overflow-auto ring-1 ring-gray-900/5 -my-px">
      <div class="relative">
        <div class="sticky top-0 px-4 py-3 flex items-center font-semibold text-sm text-gray-900 dark:text-gray-200 bg-gray-50/90 dark:bg-gray-700/90 backdrop-blur-sm ring-1 ring-gray-900/10 dark:ring-black/10">A</div>
        <div class="divide-y dark:divide-gray-200/5">
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Andrew Alfred</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Aisha Houston</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Anna White</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Andy Flint</strong>
          </div>
        </div>
      </div>
      <div class="relative">
        <div class="sticky top-0 px-4 py-3 flex items-center font-semibold text-sm text-gray-900 dark:text-gray-200 bg-gray-50/90 dark:bg-gray-700/90 backdrop-blur-sm ring-1 ring-gray-900/10 dark:ring-black/10">B</div>
        <div class="divide-y dark:divide-gray-200/5">
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Bob Alfred</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Bianca Houston</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Brianna White</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Bert Flint</strong>
          </div>
        </div>
      </div>
      <div class="relative">
        <div class="sticky top-0 px-4 py-3 flex items-center font-semibold text-sm text-gray-900 dark:text-gray-200 bg-gray-50/90 dark:bg-gray-700/90 backdrop-blur-sm ring-1 ring-gray-900/10 dark:ring-black/10">C</div>
        <div class="divide-y dark:divide-gray-200/5">
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Colton Alfred</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Cynthia Houston</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Cheyenne White</strong>
          </div>
          <div class="flex items-center gap-4 p-4">
            <img class="w-12 h-12 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80" />
            <strong class="text-gray-900 text-sm font-medium dark:text-gray-200">Charlie Flint</strong>
          </div>
        </div>
      </div>
    </div>
