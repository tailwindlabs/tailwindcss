...
export const classes = {
  ...
  preview: (css, { className }) => (
    <td
      className={`w-16 font-medium text-base whitespace-nowrap align-middle ${className}`}
      style={{
...
<template preview class="text-center p-6">
  <div class="max-w-xs">
    <input class="block appearance-none placeholder-gray-500 border rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
    <input class="mt-4 block appearance-none placeholder-red-300 border border-red-400 rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
  </div>
</template>
...
<template preview>
  <div class="space-y-4">
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-100 border rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-75 border rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-50 border rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-25 border rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
    </div>
    <div class="max-w-xs">
      <input class="block appearance-none placeholder-gray-500 placeholder-opacity-0 border rounded-md w-full py-3 px-4 text-gray-700 leading-5" placeholder="jane@example.com">
    </div>
  </div>
</template>
...
<template preview class="text-center p-6">
  <div class="max-w-xs mx-auto">
    <input class="block appearance-none bg-gray-200 placeholder-gray-600 border border-transparent focus:border-gray-300 focus:bg-white focus:placeholder-gray-400 rounded w-full py-3 px-4 text-gray-700 leading-5 focus:outline-none" placeholder="jane@example.com">
  </div>
</template>
