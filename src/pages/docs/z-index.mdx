...
<template preview class="p-4">
  <div class="relative h-28 text-center">
    <div class="z-40 absolute w-20 h-20 ml-0 mt-0 bg-fuchsia-500 border-r border-opacity-50 border-fuchsia-600 rounded-md shadow-md flex justify-center items-center text-white text-2xl font-extrabold">5</div>
    <div class="z-30 absolute w-20 h-20 ml-12 mt-2 bg-fuchsia-500 border-r border-opacity-50 border-fuchsia-600 rounded-md shadow-md flex justify-center items-center text-white text-2xl font-extrabold">4</div>
    <div class="z-20 absolute w-20 h-20 ml-24 mt-4 bg-fuchsia-500 border-r border-opacity-50 border-fuchsia-600 rounded-md shadow-md flex justify-center items-center text-white text-2xl font-extrabold">3</div>
    <div class="z-10 absolute w-20 h-20 ml-36 mt-6 bg-fuchsia-500 border-r border-opacity-50 border-fuchsia-600 rounded-md shadow-md flex justify-center items-center text-white text-2xl font-extrabold">2</div>
    <div class="z-0 absolute w-20 h-20 ml-48 mt-8 bg-fuchsia-500 rounded-md shadow-md flex justify-center items-center text-white text-2xl font-extrabold">1</div>
  </div>
</template>
