...
<Example hint="Try hovering over the text to see the expected behaviour">
  <div class="relative text-xl text-center font-medium leading-6">
    <p class="text-gray-500 hover:text-blue-600">The quick brown fox jumps over the lazy dog.</p>
  </div>
</Example>

```html
<p class="text-gray-500 **hover:text-blue-600**">The quick brown fox...</p>
```
