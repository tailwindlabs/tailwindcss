...
<Example>
  <div class="text-xl font-medium leading-6 space-y-4">
    <p class="text-blue-600/100">The quick brown fox jumps over the lazy dog.</p>
    <p class="text-blue-600/75">The quick brown fox jumps over the lazy dog.</p>
    <p class="text-blue-600/50">The quick brown fox jumps over the lazy dog.</p>
    <p class="text-blue-600/25">The quick brown fox jumps over the lazy dog.</p>
  </div>
</Example>
