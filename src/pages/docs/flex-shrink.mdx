...
<Example resizable>
  <div class="flex gap-4 text-white text-sm font-bold font-mono leading-6 bg-stripes-indigo rounded-lg">
    ...
    <div class="p-4 w-14 h-14 flex-none rounded-lg hidden sm:flex items-center justify-center bg-indigo-300">
      03
    </div>
  </div>
</Example>
...
<Example resizable>
  <div class="flex gap-4 text-white text-sm font-bold font-mono leading-6 bg-stripes-blue rounded-lg">
    <div class="p-4 flex-1 rounded-lg flex items-center justify-center bg-blue-300">
      01
    </div>
    <div class="p-4 w-16 sm:w-64 shrink-0 rounded-lg flex items-center justify-center bg-blue-500 shadow-lg">
      02
    </div>
    <div class="p-4 flex-1 rounded-lg hidden sm:flex items-center justify-center bg-blue-300">
      03
    </div>
  </div>
</Example>
