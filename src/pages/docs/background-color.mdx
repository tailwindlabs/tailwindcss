...
<template preview>
  <div class="flex justify-center items-center">
    <button type="button" class="bg-light-blue-600 text-white font-semibold px-6 py-3 rounded-md">
      Button
    </button>
  </div>
</template>

<button class="**bg-light-blue-600** ...">Button</button>
```
...
<template preview>
  <div class="flex justify-center items-center">
    <button type="button" class="bg-emerald-600 hover:bg-light-blue-600 text-white font-semibold px-6 py-3 rounded-md">
      Button
    </button>
  </div>
</template>

<button class="bg-green-600 **hover:bg-light-blue-600** ...">Button</button>
```
