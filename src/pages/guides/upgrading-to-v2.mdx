...
Tailwind CSS v2.0 has been updated for the latest PostCSS release which requires installing `postcss` as a peer dependency alongside Tailwind itself.

Update Tailwind and install PostCSS using npm or Yarn:
