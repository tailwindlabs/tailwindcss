...
export let accessibility = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.sr-only': {
        position: 'absolute',
...
export let pointerEvents = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let visibility = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let position = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let inset = ({ matchUtilities, theme, variants }) => {
  let options = {
    values: theme('inset'),
...
export let isolation = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.isolate': {
        isolation: 'isolate',
...
export let float = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let clear = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let boxSizing = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let display = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.block': {
        display: 'block',
...
export let tableLayout = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let borderCollapse = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let transform = ({ addBase, addUtilities, variants }) => {
  addBase({
    '@defaults transform': {
      '--tw-translate-x': '0',
      '--tw-translate-y': '0',
...
export let animation = ({ matchUtilities, theme, variants, prefix }) => {
...
export let userSelect = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let resize = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let listStylePosition = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let appearance = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let gridAutoFlow = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let flexDirection = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.flex-row': {
        'flex-direction': 'row',
...
export let flexWrap = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.flex-wrap': {
        'flex-wrap': 'wrap',
...
export let placeContent = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let placeItems = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.place-items-start': {
        'place-items': 'start',
...
export let alignContent = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.content-center': {
...
export let alignItems = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.items-start': {
...
export let justifyContent = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.justify-start': {
...
export let justifyItems = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.justify-items-start': {
        'justify-items': 'start',
...
export let space = ({ matchUtilities, addUtilities, theme, variants }) => {
  matchUtilities(
    {
      'space-x': (value) => {
...
export let divideWidth = ({ matchUtilities, addUtilities, theme, variants }) => {
  matchUtilities(
    {
      'divide-x': (value) => {
        value = value === '0' ? '0px' : value
...
export let divideStyle = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let divideColor = ({ matchUtilities, theme, variants, corePlugins }) => {
  matchUtilities(
    {
      divide: (value) => {
...
export let divideOpacity = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let placeSelf = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.place-self-auto': {
        'place-self': 'auto',
...
export let alignSelf = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.self-auto': {
        'align-self': 'auto',
...
export let justifySelf = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.justify-self-auto': {
        'justify-self': 'auto',
...
export let overflow = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let overscrollBehavior = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let textOverflow = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.truncate': {
        overflow: 'hidden',
...
export let whitespace = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let wordBreak = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.break-normal': {
...
export let borderStyle = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.border-solid': {
        'border-style': 'solid',
...
export let borderColor = ({ addBase, matchUtilities, theme, variants, corePlugins }) => {
...
export let backgroundColor = ({ matchUtilities, theme, variants, corePlugins }) => {
  matchUtilities(
    {
      bg: (value) => {
...
export let boxDecorationBreak = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.decoration-slice': {
...
export let backgroundAttachment = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let backgroundClip = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let backgroundRepeat = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let backgroundOrigin = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let fill = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      fill: (value) => {
...
export let stroke = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      stroke: (value) => {
        return {
...
export let objectFit = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let textAlign = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let verticalAlign = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let fontSize = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      text: (value) => {
...
export let textTransform = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let fontStyle = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let fontVariantNumeric = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let textColor = ({ matchUtilities, theme, variants, corePlugins }) => {
  matchUtilities(
    {
      text: (value) => {
...
export let textDecoration = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let fontSmoothing = ({ addUtilities, variants }) => {
  addUtilities(
    {
      '.antialiased': {
...
export let placeholderColor = ({ matchUtilities, theme, variants, corePlugins }) => {
  matchUtilities(
    {
      placeholder: (value) => {
...
export let placeholderOpacity = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let caretColor = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      caret: (value) => {
...
export let accentColor = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      accent: (value) => {
...
export let backgroundBlendMode = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let mixBlendMode = ({ addUtilities, variants }) => {
  addUtilities(
    {
...
export let outline = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      outline: (value) => {
...
export let ringWidth = ({ matchUtilities, addBase, addUtilities, theme, variants }) => {
...
export let ringColor = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      ring: (value) => {
        return withAlphaVariable({
...
export let ringOffsetColor = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      'ring-offset': (value) => {
        return {
...
export let blur = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      blur: (value) => {
        return {
...
export let brightness = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      brightness: (value) => {
        return {
...
export let contrast = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      contrast: (value) => {
        return {
...
export let dropShadow = ({ addUtilities, theme, variants }) => {
...
export let grayscale = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      grayscale: (value) => {
        return {
...
export let hueRotate = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      'hue-rotate': (value) => {
        return {
...
export let invert = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      invert: (value) => {
        return {
...
export let saturate = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      saturate: (value) => {
        return {
...
export let sepia = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      sepia: (value) => {
        return {
...
export let filter = ({ addBase, addUtilities, variants }) => {
  addBase({
    '@defaults filter': {
...
export let backdropBlur = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
      'backdrop-blur': (value) => {
        return {
...
export let backdropBrightness = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropContrast = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropGrayscale = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropHueRotate = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropInvert = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropOpacity = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropSaturate = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropSepia = ({ matchUtilities, theme, variants }) => {
  matchUtilities(
    {
...
export let backdropFilter = ({ addBase, addUtilities, variants }) => {
  addBase({
    '@defaults backdrop-filter': {
...
export let transitionProperty = ({ matchUtilities, theme, variants }) => {
