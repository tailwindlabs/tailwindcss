...
export function CodeWindow({ children, className, border = true }) {
  return (
    <div
      className={clsx(
        'relative overflow-hidden shadow-xl flex bg-gray-800 h-[31.625rem] max-h-[60vh] sm:max-h-[none] sm:rounded-xl lg:h-[34.6875rem] xl:h-[31.625rem]',
        className
      )}
    >
      <div className="relative w-full flex flex-col">
        <div className={clsx('flex-none', border && 'border-b border-gray-500/30')}>
    ...
    <div className="w-full flex-auto flex min-h-0 overflow-auto">
      <div ref={ref} className="w-full relative flex-auto">
        <pre className="flex min-h-full text-sm leading-6">
          ...
          <code className="flex-auto relative block text-gray-50 pt-4 pb-4 px-4 overflow-auto">
        ...
        <div className="w-full relative flex-auto">
          ...
          >
            {showLineNumbers && (
              <div
                aria-hidden="true"
                className="hidden md:block text-gray-600 flex-none py-4 pr-4 text-right select-none w-[3.125rem]"
              >
            ...
            <code
              className={clsx(
                'flex-auto relative block text-gray-50',
                {
