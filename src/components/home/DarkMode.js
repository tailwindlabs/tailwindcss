...
const { code, tokens } = tokenize.html(
  ...
  <div class="space-y-2">
    ...
    <div class="flex justify-between text-sm leading-5 font-medium tabular-nums text-gray-500 dark:text-gray-400">
      <div>24:16</div>
      <div>75:50</div>
    </div>
  </div>
...
<div class="lg:rounded-b-xl bg-gray-50 text-black py-4 px-1 sm:px-3 lg:px-1 xl:px-3 grid grid-cols-5 sm:grid-cols-7 lg:grid-cols-5 xl:grid-cols-7 items-center dark:bg-gray-900 dark:text-white">
  ...
  <button type="button" class="mx-auto">
    <svg width="50" height="50" fill="none">
      <circle cx="25" cy="25" r="24" stroke="currentColor" stroke-width="1.5" class="text-gray-300 dark:text-gray-500" />
  ...
  <button
    type="button"
    class="mx-auto border border-gray-300 rounded-md text-sm leading-5 font-medium py-0.5 px-2 text-gray-500 dark:border-gray-600 dark:text-gray-400"
  >
    1.0x
  </button>
</div>`,
