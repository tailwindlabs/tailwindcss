            ...
            >
              ...
              <pre
                ...
                style={{
                  ...
                  whiteSpace: 'pre',
                  fontFamily:
                    '"Inter var", system-ui, -apple-system, system-ui, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
                  fontSize: '16px',
                  fontStyle: 'normal',
                  fontVariant: 'normal',
                  fontWeight: 400,
