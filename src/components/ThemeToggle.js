  ...
  return (
    ...
    >
      <path
        ...
        className={
          selected ? 'fill-sky-400/20 stroke-sky-500' : 'stroke-gray-400 dark:stroke-gray-500'
        }
      />
      <path
        d="M12 4v1M17.66 6.344l-.828.828M20.005 12.004h-1M17.66 17.664l-.828-.828M12 20.01V19M6.34 17.664l.835-.836M3.995 12.004h1.01M6 6l.835.836"
        className={selected ? 'stroke-sky-500' : 'stroke-gray-400 dark:stroke-gray-500'}
      />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        ...
        className={selected ? 'fill-sky-500' : 'fill-gray-400 dark:fill-gray-500'}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        strokeLinejoin="round"
        className={
          selected ? 'stroke-sky-500 fill-sky-400/20' : 'stroke-gray-400 dark:stroke-gray-500'
        }
      />
      <path
...
export function ThemeSelect() {
  ...
  return (
    <div className="flex items-center justify-between">
      <label htmlFor="theme" className="text-gray-700 font-normal dark:text-gray-400">
        Switch theme
      </label>
