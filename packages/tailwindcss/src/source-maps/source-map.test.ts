...
test('source maps trace back to @import location', async ({ expect }) => {
  ...
  expect(annotations).toEqual([
    ...
    'preflight.css: 121:4-51 <- 297:2-49',
    'preflight.css: 122:6-20 <- 298:4-18',
    'preflight.css: 123:8-65 <- 299:6-63',
    'preflight.css: 127:2-11 <- 308:0-9',
    'preflight.css: 128:4-20 <- 309:2-18',
    'preflight.css: 130:2-30 <- 316:0-28',
    'preflight.css: 131:4-28 <- 317:2-26',
    'preflight.css: 133:2-32 <- 325:0-30',
    'preflight.css: 134:4-19 <- 326:2-17',
    'preflight.css: 135:4-23 <- 327:2-21',
    'preflight.css: 137:2-26 <- 334:0-24',
    'preflight.css: 138:4-24 <- 335:2-22',
    'preflight.css: 140:2-41 <- 342:0-39',
    'preflight.css: 141:4-14 <- 343:2-12',
    'preflight.css: 143:2-329 <- 346:0-354:39',
    'preflight.css: 144:4-20 <- 355:2-18',
    'preflight.css: 146:2-38 <- 362:0-36',
    'preflight.css: 147:4-18 <- 363:2-16',
    'preflight.css: 149:2-19 <- 370:0-17',
    'preflight.css: 150:4-20 <- 371:2-18',
    'preflight.css: 152:2-96 <- 378:0-380:23',
    'preflight.css: 153:4-22 <- 381:2-20',
    'preflight.css: 155:2-59 <- 388:0-389:28',
    'preflight.css: 156:4-16 <- 390:2-14',
    'preflight.css: 158:2-47 <- 397:0-45',
    'preflight.css: 159:4-28 <- 398:2-26',
