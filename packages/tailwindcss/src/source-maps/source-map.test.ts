    ...
    "
     ...
     73      border-collapse: collapse;                                                                  | 166    border-collapse: collapse; /* 3 */
             ^^^^^^^^^^^^^^^^^^^^^^^^^ BQ @ 73:4-29                                                      |        ^^^^^^^^^^^^^^^^^^^^^^^^^ BQ @ 166:2-27
                                                                                                         | 167  }
     74    }                                                                                             | 
     75    :-moz-focusring:where(:not(iframe)) {                                                         | 174    outline: auto;
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ BR @ 75:2-38                                             |        ^^^^^^^^^^^^^ BR @ 174:2-15
                                                                                                         | 175  }
     76      outline: auto;                                                                              | 
             ^^^^^^^^^^^^^ BR @ 76:4-17                                                                  | 
     77    }                                                                                             | 
...
test('@variant generates source maps', async ({ expect }) => {
  ...
  expect(annotations).toMatchInlineSnapshot(`
    "
     ...
     7  .foo[data-a][data-d] {                            |  8        color: blue;
        ^^^^^^^^^^^^^^^^^^^^^ C @ 7:0-21                  |           ^^^^^^^^^^^ C @ 8:6-17
                                                          |  9      }
                                                          | 10    }
                                                          | 11  }
     8    color: blue;                                    | 
          ^^^^^^^^^^^ C @ 8:2-13                          | 
     9  }                                                 | 
    10  .foo[data-a][data-e][data-f] {                    | 
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ C @ 10:0-29         | 
    11    color: blue;                                    | 
          ^^^^^^^^^^^ C @ 11:2-13                         | 
    12  }                                                 | 
    13  .foo[data-b][data-c] {                            | 
        ^^^^^^^^^^^^^^^^^^^^^ B @ 13:0-21                 | 
    14    color: green;                                   | 
          ^^^^^^^^^^^^ B @ 14:2-14                        | 
    15  }                                                 | 
    16  .foo[data-b][data-c][data-d] {                    | 
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ C @ 16:0-29         | 
    17    color: blue;                                    | 
          ^^^^^^^^^^^ C @ 17:2-13                         | 
    18  }                                                 | 
    19  .foo[data-b][data-c][data-e][data-f] {            | 
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ C @ 19:0-37 | 
    20    color: blue;                                    | 
          ^^^^^^^^^^^ C @ 20:2-13                         | 
    21  }                                                 | 
