...
- _Experimental_: Add `details-content` variant ([#15319](https://github.com/tailwindlabs/tailwindcss/pull/15319)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2143)
- _Experimental_: Add `inverted-colors` variant ([#11693](https://github.com/tailwindlabs/tailwindcss/pull/11693)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2142)
- _Experimental_: Add `scripting`, `scripting-none`, and `scripting-initial` variants ([#11929](https://github.com/tailwindlabs/tailwindcss/pull/11929)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2141)
- _Experimental_: Add `pointer-none`, `pointer-coarse`, and `pointer-fine` variant ([#16946](https://github.com/tailwindlabs/tailwindcss/pull/16946)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2140)
- _Experimental_: Add `any-pointer-none`, `any-pointer-coarse`, and `any-pointer-fine` variants ([#16941](https://github.com/tailwindlabs/tailwindcss/pull/16941)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2140)
- _Experimental_: Add `user-valid` and `user-invalid` variants ([#12370](https://github.com/tailwindlabs/tailwindcss/pull/12370)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2139)
- _Experimental_: Add `wrap-anywhere`, `wrap-break-word`, and `wrap-normal` utilities ([#12128](https://github.com/tailwindlabs/tailwindcss/pull/12128)) [docs](https://github.com/tailwindlabs/tailwindcss.com/pull/2138)
