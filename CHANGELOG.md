...
- Ensure `@tailwindcss/postcss` recompiles when the input CSS changes even if the `from` file's mtime is unchanged, such as when the CSS is generated by a preprocessor like Sass ([#20310](https://github.com/tailwindlabs/tailwindcss/pull/20310))
