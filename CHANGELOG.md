...
- Attribute selectors in `data-` and `aria-` modifiers are now wrapped in parentheses by default, allowing numbers and spaces in them ([#14037])(https://github.com/tailwindlabs/tailwindcss/pull/14037)
