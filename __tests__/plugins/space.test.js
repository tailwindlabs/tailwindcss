...
test('generating space utilities', () => {
  ...
  expect(utilities).toEqual([
    [
      {
        '.space-y-0 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-y-reverse': '0',
          'margin-top': 'calc(0px * calc(1 - var(--space-y-reverse)))',
          'margin-bottom': 'calc(0px * var(--space-y-reverse))',
        },
        '.space-x-0 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-x-reverse': '0',
          'margin-right': 'calc(0px * var(--space-x-reverse))',
          'margin-left': 'calc(0px * calc(1 - var(--space-x-reverse)))',
        },
        '.space-y-1 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-y-reverse': '0',
          'margin-top': 'calc(1px * calc(1 - var(--space-y-reverse)))',
          'margin-bottom': 'calc(1px * var(--space-y-reverse))',
        },
        '.space-x-1 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-x-reverse': '0',
          'margin-right': 'calc(1px * var(--space-x-reverse))',
          'margin-left': 'calc(1px * calc(1 - var(--space-x-reverse)))',
        },
        '.space-y-2 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-y-reverse': '0',
          'margin-top': 'calc(2px * calc(1 - var(--space-y-reverse)))',
          'margin-bottom': 'calc(2px * var(--space-y-reverse))',
        },
        '.space-x-2 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-x-reverse': '0',
          'margin-right': 'calc(2px * var(--space-x-reverse))',
          'margin-left': 'calc(2px * calc(1 - var(--space-x-reverse)))',
        },
        '.space-y-4 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-y-reverse': '0',
          'margin-top': 'calc(4px * calc(1 - var(--space-y-reverse)))',
          'margin-bottom': 'calc(4px * var(--space-y-reverse))',
        },
        '.space-x-4 > :not(template):not([type=hidden]) ~ :not(template):not([type=hidden])': {
          '--space-x-reverse': '0',
