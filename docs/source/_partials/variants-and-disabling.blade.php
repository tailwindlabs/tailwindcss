@php
    if ($variants) {
        ...
        $whichVariants = 'no responsive, hover, focus, or group-hover';

        $currentVariants = 'false';
...
<p>For example, this config will {{ $variants ? 'also ' : '' }}generate {{ $extraVariants }} variants:</p>
