...
Vue.component('responsive-code-sample', __webpack_require__(7));
...
Component.options.__file = "source/_assets/js/components/ResponsiveCodeSample.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7722d58e", Component.options)
  } else {
    hotAPI.reload("data-v-7722d58e", Component.options)
' + '  }
...
var _escapeHtml = __webpack_require__(10);
...
exports.default = {
  ...
  computed: {
    highlightedCode: function highlightedCode() {
      ...
      return (0, _escapeHtml2.default)(this.code).replace(regex, '<span class="text-purple">$1</span>').replace(/none:/g, '');
    }
  }
}; //
//
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "flex items-end justify-end pb-2" }, [
      _c(
        "svg",
        {
          staticClass: "inline-block cursor-pointer mr-4",
          class:
        ...
        [
          _c("path", {
            attrs: {
              id: "a",
              d:
                "M3.625 9a.6.6 0 0 0-.184-.441A.607.607 0 0 0 3 8.375a.596.596 0 0 0-.441.184.604.604 0 0 0-.184.441c0 .17.061.318.184.441s.27.185.441.184a.607.607 0 0 0 .441-.184A.6.6 0 0 0 3.625 9zM5.25 7.75v-5.5a.24.24 0 0 0-.074-.176A.24.24 0 0 0 5 2H1a.24.24 0 0 0-.176.074.24.24 0 0 0-.074.176v5.5a.24.24 0 0 0 .074.176A.24.24 0 0 0 1 8h4a.24.24 0 0 0 .176-.074.24.24 0 0 0 .074-.176zm-1.5-6.625c0-.083-.042-.125-.125-.125h-1.25c-.083 0-.125.042-.125.125 0 .083.042.125.125.125h1.25c.083 0 .125-.042.125-.125zM6 1v8a.96.96 0 0 1-.297.703A.96.96 0 0 1 5 10H1a.96.96 0 0 1-.703-.297A.96.96 0 0 1 0 9V1A.96.96 0 0 1 .297.297.96.96 0 0 1 1 0h4a.96.96 0 0 1 .703.297A.96.96 0 0 1 6 1z"
            }
          })
        ]
      ),
      ...
      _c(
        "svg",
        {
          staticClass: "inline-block cursor-pointer mr-4",
          class:
            _vm.activeScreen === "sm" ? "text-slate-dark" : "text-slate-light",
          attrs: {
            width: "18",
            height: "22",
            viewBox: "0 0 9 11",
        ...
        [
          _c("path", {
            attrs: {
              id: "a",
              d:
                "M5 10a.483.483 0 0 0-.148-.352A.476.476 0 0 0 4.5 9.5a.486.486 0 0 0-.352.148A.479.479 0 0 0 4 10c0 .137.05.254.148.352a.486.486 0 0 0 .352.148.476.476 0 0 0 .352-.148A.483.483 0 0 0 5 10zm3-1.25v-7.5a.24.24 0 0 0-.074-.176A.24.24 0 0 0 7.75 1h-6.5a.24.24 0 0 0-.176.074A.24.24 0 0 0 1 1.25v7.5a.24.24 0 0 0 .074.176A.24.24 0 0 0 1.25 9h6.5a.24.24 0 0 0 .176-.074A.24.24 0 0 0 8 8.75zm1-7.5v8.5c0 .344-.122.638-.367.883A1.204 1.204 0 0 1 7.75 11h-6.5c-.344 0-.638-.122-.883-.367A1.204 1.204 0 0 1 0 9.75v-8.5C0 .906.122.612.367.367S.906 0 1.25 0h6.5c.344 0 .638.122.883.367S9 .906 9 1.25z"
            }
          })
        ]
      ),
      ...
      _c(
        "svg",
        {
          staticClass: "inline-block cursor-pointer mr-4",
          class:
            _vm.activeScreen === "md" ? "text-slate-dark" : "text-slate-light",
          attrs: {
            width: "28",
            height: "22",
            viewBox: "0 0 14 11",
      ...
      _c(
        "svg",
        {
          staticClass: "inline-block cursor-pointer mr-4",
          class:
            _vm.activeScreen === "lg" ? "text-slate-dark" : "text-slate-light",
          attrs: {
            width: "34",
            height: "24",
            viewBox: "0 0 17 12",
      ...
      _c(
        "svg",
        {
          ...
          class:
            _vm.activeScreen === "xl" ? "text-slate-dark" : "text-slate-light",
          attrs: {
            width: "38",
            height: "30",
            viewBox: "0 0 19 15",
    ...
    _vm._v(" "),
    _c("div", { staticClass: "rounded mask border-2 border-smoke mb-8" }, [
      _c(
        "div",
        { staticClass: "p-4 bg-smoke-lighter border-b-2 border-smoke" },
        [
          _c("div", {
            staticClass:
              "whitespace-pre font-mono text-slate-lighter text-sm overflow-x-scroll",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7722d58e", module.exports)
  }
}
