    ...
    <div class="min-h-screen bg-pattern bg-center bg-smoke-light border-t-6 border-tailwind-teal flex items-center justify-center leading-tight p-6 pb-16">
        <div>
            <div>
                ...
                <p class="text-center">
                <a href="https://github.com/tailwindcss/tailwindcss/tree/v{{ $page->version }}" target="_blank" class="text-lg text-grey hover:text-grey-dark font-semibold tracking-tight">v{{ $page->version }}</a>
                </p>
            </div>
